...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/EgoBots/EGO-MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/RemixSuport")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+t4XABVB-yFJkZTU1")
